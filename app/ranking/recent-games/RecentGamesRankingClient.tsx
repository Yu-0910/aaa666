...
export default function RecentGamesRankingClient({ snapshot, metrics, league, sort, order, weekMeta }: {
  ...
  return <>
    <div className="pb-[calc(env(safe-area-inset-bottom)+112px)]">
      <RankingUI
    ...
    <RankingPageBottomLinkNav
      ariaLabel="直近10試合ランキング切り替え"
      items={[
        { href: "/ranking/recent-games/2026/CL/batting", label: "セ野手", icon: "batting", active: league === "CL" },
        { href: "/ranking/recent-games/2026/PL/batting", label: "パ野手", icon: "batting", active: league === "PL" },
      ]}
    />
  </>
}
