    ...
    <WeeklyPageShell emptyNoData={emptyNoData} emptyAfterFilter={emptyAfterFilter} league={league}>
      ...
      {league === "CL" || league === "PL" ? (
        <RankingPageBottomLinkNav
          ...
          items={[
            { href: `/ranking/weekly/${year}/${weekKey}/CL`, label: "セ野手", icon: "batting", active: league === "CL" },
            { href: `/ranking/pitching/weekly/${year}/${weekKey}/CL`, label: "セ投手", icon: "pitching" },
            { href: `/ranking/weekly/${year}/${weekKey}/PL`, label: "パ野手", icon: "batting", active: league === "PL" },
            { href: `/ranking/pitching/weekly/${year}/${weekKey}/PL`, label: "パ投手", icon: "pitching" },
          ]}
        />
      ) : null}
