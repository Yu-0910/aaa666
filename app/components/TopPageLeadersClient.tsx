                ...
                <div key={metric} className="top-page-table-shell site-bg border border-[#555] rounded p-1 relative min-w-0">
                  <div className="relative mb-1 flex min-h-[22px] items-center">
                    ...
                    <button
                      ...
                      className={`relative z-20 ml-auto shrink-0 site-bg py-0.5 px-0.5 ${rowTypography.statsListLink} text-[#e8e8e8] hover:text-white transition-colors flex items-center cursor-pointer`}
                    >
                      成績一覧
                    </button>
                  </div>
            ...
            <div className="top-page-table-shell site-bg border border-[#555] rounded p-1 relative w-full">
              <div className="relative mb-1 flex min-h-[22px] items-center">
                ...
                <button
                  ...
                  className={`relative z-20 ml-auto shrink-0 site-bg py-0.5 px-1 ${rowTypography.statsListLink} text-[#e8e8e8] hover:text-white transition-colors flex items-center cursor-pointer`}
                >
                  成績一覧
                </button>
              </div>
              ...
              {usesTopBattingModernLayout(Number(year), isWeeklyBattingTab) ? (
                ...
                <div className="flex items-stretch justify-between mb-1">
                  ...
                  <button
                    ...
                    className={`site-bg py-0.5 px-1 ${rowTypography.statsListLink} text-[#e8e8e8] hover:text-white transition-colors flex items-center cursor-pointer`}
                  >
                    成績一覧
                  </button>
                </div>
              ...
              {usesTopBattingModernLayout(Number(year), isWeeklyBattingTab) ? (
                ...
                <div className="flex items-stretch justify-between mb-1">
                  ...
                  <button
                    ...
                    className={`site-bg py-0.5 px-0.5 ${rowTypography.statsListLink} text-[#e8e8e8] hover:text-white transition-colors flex items-center cursor-pointer`}
                  >
                    成績一覧
                  </button>
                </div>
