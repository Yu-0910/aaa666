...
export const STANDINGS_METRIC_COLUMNS: readonly StandingsMetricColumn[] = [
  ...
  { order: 6, label: "差", key: "gb" },
  { order: 7, label: "勝率", key: "pct" },
  { order: 8, label: "得点", key: "runs" },
  { order: 9, label: "OPS", key: "ops" },
  { order: 10, label: "打率", key: "avg" },
  { order: 11, label: "本塁打", key: "hr" },
  { order: 12, label: "安打", key: "h" },
  { order: 13, label: "単打", key: "singles" },
  { order: 14, label: "二塁打", key: "doubles" },
  { order: 15, label: "三塁打", key: "triples" },
  { order: 16, label: "出塁率", key: "obp" },
  { order: 17, label: "長打率", key: "slg" },
  { order: 18, label: "得点圏", key: "risp_avg" },
  { order: 19, label: "IsoD", key: "isod" },
  { order: 20, label: "IsoP", key: "isop" },
  { order: 21, label: "BB%", key: "bb_pct" },
  { order: 22, label: "K%", key: "k_pct" },
  { order: 23, label: "防御率", key: "era" },
  { order: 24, label: "失点", key: "runs_allowed" },
  { order: 25, label: "先発防御率", key: "era_starter" },
  { order: 26, label: "救援防御率", key: "era_relief" },
  { order: 27, label: "被打率", key: "avg_allowed" },
  { order: 28, label: "完投", key: "cg" },
  { order: 29, label: "BB%", key: "bb_pct_pitch" },
  { order: 30, label: "K率", key: "k_pct_pitch" },
  { order: 31, label: "K-BB%", key: "k_bb_pct" },
  { order: 32, label: "QS率", key: "qs_rate" },
  { order: 33, label: "HQS率", key: "hqs_rate" },
] as const
