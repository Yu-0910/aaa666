...
/** @param {{ yahooPlayerId: string | null, playerName: string, teamName?: string, yahooTeamId?: string | null, cells: string[] }} row */
...
/**
 * @param {string} html
 * @returns {{ yahooPlayerId: string | null, playerName: string, teamName?: string, yahooTeamId?: string | null, cells: string[] }[]}
 */
...
/**
 * @param {{ yahooPlayerId: string | null, playerName: string, teamName?: string, yahooTeamId?: string | null, cells: string[] }[]} rows
...
/**
 * @param {{ yahooPlayerId: string | null, playerName: string, cells: string[] }[]} rows
 */
