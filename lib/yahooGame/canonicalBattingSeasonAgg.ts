...
function lastTerminalPitchResultJa(pitchEvents: PlateAppearance["pitchEvents"]): string {
  ...
  const terminalRe =
    /三振|四球|敬遠|故意四球|申告敬遠|死球|犠打|捕犠|送りバント|犠飛|犠牲フライ|犠牲飛|本塁打|ホームラン|HR|左中本|右中本|左本|右本|中本|二塁打|三塁打|[一二三遊左中右投捕][２３23]|安打|ヒット|内野安打|内安|[一二三遊左中右投捕]安|ポテンヒット|タイムリー|適時打|左飛|中飛|右飛|遊飛|投飛|捕飛|二飛|三飛|邪飛|[一二三四五六七八九]飛|[一二三遊左中右投捕]直|[一二三遊左中右投捕]失|ライナー|ゴロ|併殺|併打|ダブルプレー|ゲッツー|失策|エラー|野選|打者妨|フォアボール|ボールフォー/
